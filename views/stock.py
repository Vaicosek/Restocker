...
# CaptableImportModal removed 2026-07-16 — one-shot Crimson import used for the V Tech/GEX
# merger (applied that day). Post-merger the bot's book is authoritative; restore from git
# history only if a raw Crimson import is ever needed again.
