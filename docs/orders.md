...
- Related: `/order` (place an order), and asking the bot for restock orders / the
...
- Restock quantities are best driven by capacity shortfall (ask the bot) rather than
